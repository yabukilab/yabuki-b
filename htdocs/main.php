...
<head>
    ...
    <style>
        ...
        #option1:checked + label + .image1,
        #option2:checked + label + .image2,
        #option3:checked + label + .image3,
        #option4:checked + label + .image4,
        #option5:checked + label + .image5,
        #option6:checked + label + .image6,
        #option7:checked + label + .image7 {
            display: block;
        }
        .image-container img {
